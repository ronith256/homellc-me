/**
 * Type definitions and Type-Guards for multimodal live API
 */
...
import type {
  ...
  export type LiveConfig = {
    ...
    tools?: Array<Tool | { googleSearch: {} } | { codeExecution: {} } | { knowledgeBase: {}}>;
  };
  ...
  const prop = (a: any, prop: string, _: string = "object") =>
